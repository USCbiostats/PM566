...
## Question 2: Get details about the articles
...
publications <- GET(
  ...
  query = list("PARAMETERS OF THE QUERY")
)
...
## Question 3: Distribution of universities, schools, and departments
...
per id. This way, if a paper is missing the abstract, we will be able to see.
...
abstracts <- stringr::str_extract(pub_char_list, "[YOUR REGULAR EXPRESSION]")
 str_remove_all(titles, "[CLEAN ALL THE HTML TAGS]")
```
