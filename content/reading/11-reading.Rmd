...
- For more advanced website creation using **blogdown** and the website generators **Hugo** and **Jeckyll see [Creating websites with R Markdown](https://bookdown.org/yihui/blogdown/). [Appendix B](https://bookdown.org/yihui/blogdown/website-basics.html#website-basics) presents basic information about websites, such as HTML, CSS, and JavaScript.
