...
**Learning Objective** To apply the skills learned in PM 566 (up to Oct 8th) by analyzing and interpreting a dataset of your choice.
...
The first step in any data analysis is to have a dataset for which you have formulated an interesting question. If you do not have a dataset to work with, you may choose one from our [list of suggestions](reference/#data). With your dataset, formulate a clear and concise question to answer and conduct data wrangling, exploratory data analysis, and data visualization to explore/answer this question.
