...
Open the Quarto markdown (qmd) file called `lab-01-hello-r.qmd`. It will likely ask you if you would like to install a package that is required, click Install.
