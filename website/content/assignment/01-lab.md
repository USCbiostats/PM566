...
We recommend using RStudio as your IDE if you don't already have it installed. You can go to the [RStudio](https://rstudio.com/products/rstudio/download/) website to download and install the software. Once it is installed, open RStudio and use it to complete the rest of this lab.
...
Here is a Quarto [cheatsheet](https://rstudio.github.io/cheatsheets/quarto.pdf)
and a general [markdown cheatsheet](https://www.markdownguide.org/cheat-sheet/)
