...
<img src="https://www.w3schools.com/sql/img_innerjoin.gif" width="10%">
...
```{r}
ans <- dbGetQuery(con,
  "SELECT * FROM regional AS a
  INNER JOIN individual AS b 
...
<img src="https://www.w3schools.com/sql/img_leftjoin.gif" width="10%">
...
<img src="https://www.w3schools.com/sql/img_rightjoin.gif" width="10%">
...
```{r}
ans <- dbGetQuery(con,
  "SELECT * FROM individual AS a
  LEFT JOIN regional   AS b /* RIGHT joins are not supported by SQLite*/
  ON a.townname = b.townname
  ")
nrow(ans)
```
...
<img src="https://www.w3schools.com/sql/img_fulljoin.gif" width="10%">
