...
## Coloring by a variable{.smaller}
...
## Controlling point transparency using the "alpha" aesthetic{.smaller}
...
## Controlling point shape:{.smaller}
...
### Manual control of aesthetics{.smaller}
...
## Geoms - reference{.smaller}

ggplot2 provides over 40 geoms, and extension packages provide even more (see [https://ggplot2.tidyverse.org/reference/](https://ggplot2.tidyverse.org/reference/) for a sampling). 
...
For the tile providers, take a look at this site: [https://leaflet-extras.github.io/leaflet-providers/preview/](https://leaflet-extras.github.io/leaflet-providers/preview/)
