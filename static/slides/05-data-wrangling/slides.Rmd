...
3. Following the previous question, plot a sample of 1,000 of `(lat, lon)` 

---

```{r echo=FALSE, eval = FALSE}
# Question 1
nrow(dat[(temp < 25) & (temp > 18)])
...
# Question 3
set.seed(123)
dat[is.na(temp)][sample.int(.N, 1000), plot(lon, lat, col = "blue")]
dat[!is.na(temp)][sample.int(.N, 1000), points(lon, lat, col = "red")]
