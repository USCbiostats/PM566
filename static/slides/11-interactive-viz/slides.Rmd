...
--
  ...
  - Interactive tables (`formattable`, `as.datatable`)
...
<div style="text-align: center;">
  <figure>
    <img style="width: 50px;vertical-align: middle;"  hspace="20px" src="img/plotly.png" alt="Plotly"
  </figure>
</div>
...
- Embedding in website _HTML_

- Arrange and then save image for publication _SIEVERT_
