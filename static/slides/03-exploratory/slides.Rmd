...
---
# Exploratory Graphs
We can add a simple linear regression line to this plot using `lm()` and `abline()`
```{r out.width = '40%', out.height='40%', fig.align = "center"}
mod<- lm(temp~lat, data=met3)
plot(met3$lat, met3$temp, pch=19, cex=0.5, main="Temperature and Latitude", xlab="Latitude", ylab="Temperature (deg C)")
