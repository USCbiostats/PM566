...
Go the the the lab page for this week on the [website](/PM566/class/01-class/). You should see a "download" button under the "Lab Exercise" section. Click it to download the material.
...
```{r fig-resize-global, fig.width=2,fig.height=3, echo = FALSE}
knitr::include_graphics("../../assignment-img/fig-resize-global.png")
```
...
```{r fig-resize-local, fig.width=3,fig.height=2, echo = FALSE}
knitr::include_graphics("../../assignment-img/fig-resize-local.png")
```
...
```{r theme-highlight, fig.width=2,fig.height=3, echo = FALSE}
knitr::include_graphics("../../assignment-img/theme-highlight.png")
```
